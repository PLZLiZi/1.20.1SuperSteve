...
public class SSDeathScreen extends Screen {
    ...
    public SSDeathScreen(Component p_95911_, boolean p_95912_) {
    ...
    private void handleExitToTitleScreen() {
        if (this.hardcore) {
            ...
            ConfirmScreen $$0 = new TitleConfirmScreen((p_280795_) -> {
                if (p_280795_) {
                    this.exitToTitleScreen();
                } else {
                    this.minecraft.player.respawn();
    ...
    public boolean mouseClicked(double p_95914_, double p_95915_, int p_95916_) {
        if (this.causeOfDeath != null && p_95915_ > (double) 85.0F) {
            ...
            if (p_95915_ < (double) (85 + 9)) {
                ...
                if ($$3 != null && $$3.getClickEvent() != null && $$3.getClickEvent().getAction() == Action.OPEN_URL) {
